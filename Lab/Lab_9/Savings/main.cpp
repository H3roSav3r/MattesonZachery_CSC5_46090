...
int main(int argc, char** argv) {
    ...
    float nCmpd = 50; //number of compounding periods (yrs)
    ...
    cout<<"The More Peoples Bank Savings 7 = $"<<save8(pv, i, nCmpd)<<endl;
...
float save8(float p, float i, int n) {
    ...
    for(int year = 1; year <= n; year++) {
        ...
        p = static_cast<int>(p * 100 + 1.0f) / 100.0f;
